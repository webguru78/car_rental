...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="topNavBar">
               ...
               My Cab
                ...
                <div>
                  ...
                  <?php else: ?>
                    ...
                    <a href="./driver/login.php" class="text-reset text-decoration-none mx-2"><b>Client Panel</b></a>
