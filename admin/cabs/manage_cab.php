...
<div class="card card-outline card-purple rounded-0">
	...
	<div class="card-body">
		<form action="" id="cab-form">
            ...
            <div class="form-group">
				<label for="cab_driver" class="control-label">Client Name</label>
			...
			<div class="form-group">
				<label for="driver_contact" class="control-label">Client Contact #</label>
			...
			<div class="form-group">
				<label for="password" class="control-label">Client Account Password</label>
